    ...
    render() {
        return (
            <div className='proname'>
                ...
                <label htmlFor="ProNAME">I WILL:</label><span class='willstate'>Build a beautiful website that respectfully represents your business and make sure to establish your online campaign that can rake you alot of customers. I do a bery thorough job and my clients are very happy about what i do. You will not regret it. Because i do this best.</span>
